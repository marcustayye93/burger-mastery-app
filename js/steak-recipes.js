...
ingredients:["1 ribeye, 4 cm thick (about 400 g)","Fine salt","30 g butter","2 garlic cloves, crushed","3 sprigs thyme","Neutral high-smoke-point oil","Instant-read thermometer"],
...
{image:assets.stkPanSear,kicker:"THE SEAR",title:"Flip every 30 seconds",body:"Lay the steak away from you and flip every 30 seconds. Continuous flipping builds an even crust on both faces while the interior climbs gently and evenly — no grey band, no scorched face. Expect roughly 12 minutes for a 4 cm cut, but the thermometer decides, not the clock."},
...
ingredients:["1 thick-cut steak, 5 cm or more (ribeye, striploin or a bone-in showpiece)","Fine salt","Neutral high-smoke-point oil","Wire rack and baking tray","Instant-read thermometer"],
doneTitle:"The showpiece, mastered.",
doneBody:"Reverse sear is the only honest route for cuts past 5 cm — every other method overshoots the outside before the centre arrives. You now own the technique that handles tomahawks, thick porterhouses and every showpiece cut in the case.",
steps:[
...
{image:assets.stkReverseRack,kicker:"THE LOW OVEN",title:"Slow ride at 110°C",body:"Steak on a rack over a tray, into a 110°C oven. The gentle heat walks the interior up evenly — no gradient, no grey band. For 5 cm expect 45 to 60 minutes, but probe from 35 minutes; ovens lie and thermometers do not."},
...
ingredients:["1 flank steak (about 500 g, 2–2.5 cm)","Fine salt","Neutral high-smoke-point oil","Instant-read thermometer","A sharp slicing knife"],
...
ingredients:["2 filet mignon medallions, 4–5 cm thick","Fine salt","20 g butter plus a compound butter disc to finish","Neutral high-smoke-point oil","Oven-safe pan","Instant-read thermometer"],
...
{image:assets.stkOven,kicker:"THE OVEN",title:"Finish at 180°C",body:"Pan straight into the oven. The surrounding heat is gentler than the pan floor, letting the deep centre climb evenly — for 4 to 5 cm medallions expect 4 to 7 minutes. Start probing at 4; thickness varies more than recipes admit."},
