...
export const storySlides = {
 ...
 mixing:[
  ...
  {image:assets.texture,kicker:"LOOK FOR THIS",title:"Visible fat, loose structure",body:"Separate strands and small fat deposits are signs that the mixture has not been overworked."},
  {image:assets.portion,kicker:"NEXT STEP",title:"Portion before shaping",body:"Weighing each portion gives even cooking and makes your nutrition estimates more dependable."}
 ],
 shaping:[
  ...
  {image:assets.shaping,kicker:"PRESSURE",title:"Use only enough pressure to hold",body:"Shape the edges and surface lightly. Dense patties eat more like sausage."},
  ...
  {image:assets.dimple,kicker:"FINISH",title:"Add a shallow centre dimple",body:"For thicker patties, a subtle indentation helps reduce doming during cooking."}
 ],
 seasoning:[
  {image:assets.texture,kicker:"SEASONING",title:"Protect the texture",body:"For a loose classic burger, season the outside shortly before cooking rather than mixing salt through the meat."},
  {image:assets.sauce,kicker:"BALANCE",title:"Seasonings are only one layer",body:"Cheese, pickles and sauces add salt too. Judge the finished burger, not the patty in isolation."}
 ],
 assembly:[
  {image:assets.toast,kicker:"FOUNDATION",title:"Toast for structure",body:"A golden surface adds flavour and slows moisture from soaking into the bun."},
  ...
  {image:assets.layers,kicker:"LAYERS",title:"Keep the stack centred",body:"Even layers distribute every flavour across the bite and improve structural stability."},
