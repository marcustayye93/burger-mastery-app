...
{image:`${RAW}/meat/BM-MEAT-010-blend-tasting-composition.webp`,kicker:"BLENDS · SEE THE DIFFERENCE",title:"How blends look — and taste",body:"Top: pure beef and pure pork. Bottom: what folding them together creates. A 70/30 beef–pork blend eats noticeably juicier and softer than beef alone, while 50/50 beef–lamb turns lamb's gamey edge into rounded, savoury depth. The strands stay distinct — a blend is a marriage, not a paste."},
{image:`${RAW}/meat/BM-MEAT-011-blend-flavour-table.webp`,kicker:"BLENDS · THE GUIDE",title:"Juiciness and boldness, compared",body:"Use this map when choosing your base. Pork is the juiciness engine but tastes mild alone; lamb is the boldness engine but can overwhelm. Beef sits in the balanced centre, which is why it anchors almost every great blend. Any blend containing pork or chicken must be cooked through to 71–74°C."},
...
mixing:[
{image:assets.grindLoose,kicker:"CORRECT",title:"Keep strands distinct",body:"The meat should still look like ground meat after mixing — not a smooth paste. Every fold you add now is chewiness you will taste later."},
...
{image:assets.onionGrated,kicker:"FLAVOUR IN THE MIX",title:"Adding aromatics inside",body:"If you season inside the patty, use ingredients that disappear: well-squeezed grated onion (max 20 g per 500 g of meat — about 5–6 g for a 140 g patty) or garlic powder. Chunks of raw aromatics burn outside and stay harsh inside."},
...
shaping:[
{image:assets.pattyReady,kicker:"PORTION",title:"Begin with the target weight",body:"A 150 g patty is a balanced starting point for a standard burger. Weigh, don't eyeball — patties that match cook at the same rate."},
