...
export const burgerLessons={
  "meat-blends":[
    {id:"mb-beef",title:"Beef: The Classic Canvas",minutes:5,slides:[
      ...
      {image:A.grindLoose,kicker:"BEEF",title:"The 80/20 rule",body:"For a standard burger, 80% lean to 20% fat is the gold standard. The fat renders during cooking, basting the meat from the inside and carrying fat-soluble flavours to your palate."},
      ...
      {image:A.portion,kicker:"BEEF",title:"The problem with 90/10",body:"Very lean beef (90/10 or 95/5) dries out quickly. Without fat to lubricate the fibres, a well-done lean burger feels dense and chalky. Compensate with moisture-rich sauces."},
    ...
    {id:"mb-pork",title:"Pork: The Sweet Softener",minutes:4,slides:[
      ...
      {image:A.meatBeef,kicker:"PORK",title:"The safety rule",body:"Unlike beef, pork must always be cooked through. Use a meat thermometer to ensure the centre reaches 71°C to guarantee safety without overcooking."},
      ...
      {image:A.portion,kicker:"PORK",title:"The ultimate blend",body:"A 70% beef and 30% pork blend is a revelation. The beef provides the savoury backbone and chew, while the pork softens the bite and adds a subtle sweetness."}
    ]},
    {id:"mb-lamb",title:"Lamb: The Bold Choice",minutes:4,slides:[
      ...
      {image:A.mixing,kicker:"LAMB",title:"Fat management",body:"Lamb fat can feel heavy and coat the mouth as it cools. Serve lamb burgers hot, and ensure they have a solid sear to render as much surface fat as possible."},
      ...
      {image:A.heroPorkPairing,kicker:"LAMB",title:"What to avoid",body:"Sweet ketchup and classic American cheese clash aggressively with lamb's earthy profile. Keep the flavours leaning toward the Mediterranean."},
    ...
    {id:"mb-blending",title:"Blending Meats Like a Butcher",minutes:5,slides:[
      ...
      {image:A.heroLambPairing,kicker:"BLENDING",title:"Beef + pork (70/30)",body:"The crowd-pleaser. Beef anchors the umami while pork adds tenderness and gentle sweetness. It eats noticeably juicier and softer than beef alone."},
      ...
      {image:A.meatBeef,kicker:"BLENDING",title:"The safety floor",body:"Any blend containing pork must be cooked fully through — 71°C at the centre. Any blend containing chicken needs 74°C. Pure beef blends can be served pink."}
    ]},
    {id:"mb-fat-ratio",title:"The Science of the Fat Ratio",minutes:6,slides:[
      ...
      {image:A.onionGrated,kicker:"THE FAT RATIO",title:"Fat equals flavour",body:"Most of the compounds that give beef its distinct flavour are fat-soluble. A lean burger doesn't just taste drier; it literally tastes less beefy."},
      ...
      {image:A.portion,kicker:"THE FAT RATIO",title:"Smash burgers need fat",body:"Smash burgers require high heat and a long sear relative to their thickness. Without at least 20% fat, they will stick to the pan and dry out before a proper crust forms."},
  ...
  "grind-mix":[
    {id:"gm-grind-size",title:"Understanding Grind Size",minutes:4,slides:[
      ...
      {image:A.meatCompare,kicker:"GRIND SIZE",title:"The supermarket standard",body:"Most supermarket ground beef is a medium-fine grind. It holds together easily but can become dense if overworked. Handle it with extreme care."},
      ...
      {image:A.portion,kicker:"GRIND SIZE",title:"Fat distribution",body:"A good grind distributes fat evenly in small flecks. If you see massive white chunks or long strings of fat, the grinder was dull and smeared the fat instead of cutting it."},
    ...
    {id:"gm-temperature",title:"Temperature Control",minutes:5,slides:[
      ...
      {image:A.texture,kicker:"TEMPERATURE",title:"The smearing problem",body:"Smeared fat melts out of the burger immediately when it hits the pan, leaving you with a dry, dense puck. Distinct cold fat pockets render slowly, basting the meat."},
      ...
      {image:A.onionGrated,kicker:"TEMPERATURE",title:"Chill the bowls",body:"If you are mixing a large batch or grinding your own meat, put your mixing bowls and grinder parts in the freezer for 20 minutes first. Cold equipment protects the fat."},
    ...
    {id:"gm-mixing-technique",title:"The Art of the Gentle Mix",minutes:5,slides:[
      {image:A.onionGrated,kicker:"GRIND & MIX",title:"The sausage effect",body:"When you knead ground meat, you dissolve the protein myosin. This protein acts like glue, binding the meat together into a tight, springy matrix — exactly what you want for sausage, and exactly what ruins a burger."},
      ...
      {image:A.meatBeef,kicker:"TECHNIQUE",title:"Less is more",body:"Stop mixing the exact second the ingredients look evenly distributed. Every additional fold you make is chewiness you will taste later."},
      ...
      {image:A.mixing,kicker:"TECHNIQUE",title:"The drop test",body:"If you drop a piece of the mixed meat onto the counter and it bounces or holds its shape perfectly, it's overworked. It should slump and feel delicate."}
    ]},
    {id:"gm-aromatics",title:"Aromatics in the Mix",minutes:6,slides:[
      ...
      {image:A.onionMidCaramel,kicker:"AROMATICS",title:"The grated solution",body:"If you want onion inside, grate it. Grated onion melts invisibly into the mix, providing subtle sweetness and noticeable moisture. Max 20g per 500g of meat."},
    ...
    {id:"gm-salt-timing",title:"Why We Never Salt the Mix",minutes:5,slides:[
      ...
      {image:A.seasoningEven,kicker:"SALT TIMING",title:"The science",body:"Salt draws out moisture and breaks down meat proteins. Within minutes of salting the mix, the proteins cross-link, turning the tender crumb into a dense, rubbery puck."},
      ...
      {image:A.seasoningCrust,kicker:"SALT TIMING",title:"The exception",body:"The only time you salt the mix is if you are making a deliberate sausage-style patty (like a Cevapi burger) where that bouncy, tight texture is the goal."},
  ...
  "shape-structure":[
    {id:"ss-portioning",title:"Portioning for Purpose",minutes:4,slides:[
      ...
      {image:A.grindLoose,kicker:"PORTIONING",title:"The smash weight",body:"For a smash burger, 60g to 80g is the ideal window. Any smaller and it burns; any larger and it won't smash thin enough to maximize the crust-to-meat ratio."},
      ...
      {image:A.garlicInMeat,kicker:"PORTIONING",title:"The pub weight",body:"Thick pub-style burgers range from 200g to 225g (1/2 lb). At this weight, you must manage the heat carefully to cook the centre without burning the exterior."},
    ...
    {id:"ss-gentle-shaping",title:"The Gentle Shape",minutes:5,slides:[
      ...
      {image:A.dimple,kicker:"SHAPING",title:"The tossing method",body:"Instead of pressing the meat into a puck, gently toss the portion back and forth between your cupped hands. This rounds the edges naturally without compressing the centre."},
      ...
      {image:A.pattyReady,kicker:"SHAPING",title:"Using a ring",body:"If you struggle with consistency, use a metal pastry ring or the lid of a large jar lined with cling film. Press the meat in gently just to reach the edges, then pop it out."},
    ...
    {id:"ss-the-dimple",title:"The Dimple Trick",minutes:4,slides:[
      ...
      {image:A.shaping,kicker:"THE DIMPLE",title:"Why doming ruins burgers",body:"A domed patty cooks unevenly, refuses to hold toppings securely, and makes the burger difficult to eat. You want a flat, even surface from edge to edge."},
      ...
      {image:A.thickness,kicker:"THE DIMPLE",title:"The flattening out",body:"As the edges contract during cooking, they will pull the meat outward. The dimple will rise and flatten out, leaving you with a perfectly level patty."},
    ...
    {id:"ss-smash-technique",title:"The Smash Technique",minutes:6,slides:[
      ...
      {image:A.heroCross,kicker:"SMASHING",title:"Start with a ball",body:"Do not pre-shape smash patties. Roll the 70g portion into a loose meatball. This ensures that when you smash it, the meat spreads outward evenly."},
      ...
      {image:A.portion,kicker:"SMASHING",title:"The equipment",body:"You need a heavy, flat, unslotted spatula or a dedicated burger press. Use a second utensil (like the handle of a wooden spoon) to press down on the spatula for maximum leverage."},
    ...
    {id:"ss-thickness-heat",title:"Matching Thickness to Heat",minutes:5,slides:[
      ...
      {image:A.heroSmash,kicker:"THICKNESS",title:"Thin patties (Smash)",body:"Needs ripping hot heat. The goal is to build a massive crust in 60 seconds before the thin centre overcooks. Flip once, add cheese, remove quickly."},
      ...
      {image:A.shaping,kicker:"THICKNESS",title:"Thick patties (Pub)",body:"Needs a two-stage cook. Sear hard on both sides, then lower the heat significantly (or move to a cooler zone on a grill) to let the centre reach target temperature gently."},
  ...
  "season-crust":[
    {id:"sc-the-maillard-reaction",title:"The Maillard Reaction",minutes:5,slides:[
      ...
      {image:A.seasoningBlend,kicker:"MAILLARD",title:"Moisture is the enemy",body:"Water boils at 100°C. If your meat is wet, the pan's energy goes into boiling the water rather than heating the meat to the 140°C needed for browning. Dry the meat surface."},
      ...
      {image:A.seasoningOneSide,kicker:"MAILLARD",title:"Contact matters",body:"The reaction only happens where the meat touches the metal. Pressing the patty gently (or smashing it) ensures maximum surface contact and an even, wall-to-wall crust."},
    ...
    {id:"sc-salt-application",title:"The Rules of Salt",minutes:4,slides:[
      ...
      {image:A.seasoningBlend,kicker:"SALT",title:"Weigh your salt",body:"Use exactly 1% of the patty's weight in salt. For a 150g patty, that is 1.5g of salt. Eyeballing leads to inconsistency; a cheap digital scale guarantees perfection."},
    ...
    {id:"sc-pepper-spices",title:"Pepper and Spices",minutes:5,slides:[
      ...
      {image:A.seasoningEven,kicker:"PEPPER",title:"The coarse grind",body:"Use a coarse grind. Large pieces of pepper toast in the hot fat, mellowing their bite and creating aromatic, crunchy pockets in the crust."},
      ...
      {image:A.seasoningCrust,kicker:"SPICES",title:"The burning risk",body:"Spices burn faster than meat. If you use a heavy spice rub, you must lower the pan heat slightly to prevent the paprika or garlic powder from turning bitter and acrid."},
    ...
    {id:"sc-the-flip",title:"The Perfect Flip",minutes:4,slides:[
      ...
      {image:A.cookingChickenSeasoning,kicker:"THE FLIP",title:"The release",body:"A proper crust will naturally release from a hot pan. If you feel heavy resistance when sliding the spatula under a classic patty, wait 30 seconds. (Smash burgers are the exception)."},
      ...
      {image:A.xsecChicken,kicker:"THE FLIP",title:"One flip vs. many",body:"Flipping once builds a thicker, more distinct crust on each side. Flipping multiple times (every 30 seconds) cooks the centre faster and more evenly. Both are valid techniques."},
    ...
    {id:"sc-doneness-safety",title:"Burger Doneness & Safety",minutes:5,slides:[
      ...
      {image:A.heroEditorial,kicker:"DONENESS",title:"The safe pink window",body:"Freshly ground, high-quality beef from a trusted butcher can be served at 57–60°C — juicy with a blush of pink. Supermarket pre-ground beef is safest at 68–71°C."},
      ...
      {image:A.portion,kicker:"DONENESS",title:"Probe through the side",body:"Insert the thermometer horizontally through the side of the patty to reach the dead centre. A vertical probe in a thin patty reads the pan heat, not the meat."},
    ...
    {id:"sc-pan-management",title:"Managing the Pan",minutes:5,slides:[
      ...
      {image:A.meatChickenBreast,kicker:"PAN MANAGEMENT",title:"Crowding the pan",body:"Do not put four patties in a small pan. They will drop the temperature, release water, and steam each other. Leave at least an inch of space around every patty."},
      ...
      {image:A.meatChickenFlatlay,kicker:"PAN MANAGEMENT",title:"The fond",body:"The browned bits stuck to the pan after cooking are called the fond. If you are making a batch of burgers, wipe the pan out if the fond turns black and bitter."},
  ...
  "cheese-melt":[
    {id:"cm-american-cheese",title:"The American Standard",minutes:4,slides:[
      ...
      {image:A.finished,kicker:"AMERICAN CHEESE",title:"The science of the melt",body:"American cheese contains sodium citrate, an emulsifying salt that prevents the fat and water proteins from separating under heat. This is why it melts instead of sweating grease."},
      ...
      {image:A.heroEditorial,kicker:"AMERICAN CHEESE",title:"Deli vs. plastic-wrapped",body:"Always buy deli-sliced American cheese if possible. The individually plastic-wrapped singles contain more stabilizers and less actual cheese, resulting in a slightly plastic texture."},
    ...
    {id:"cm-aged-cheeses",title:"Working with Aged Cheeses",minutes:5,slides:[
      {image:A.heroSteakhouse,kicker:"CHEESE & THE MELT",title:"The splitting problem",body:"Aged cheeses like sharp cheddar or mature gruyere taste incredible, but they lack emulsifiers. Under high heat, their fat separates from their protein, leaving a greasy puddle and a rubbery lump."},
      ...
      {image:A.finished,kicker:"AGED CHEESE",title:"The low-heat melt",body:"Aged cheese needs gentle heat. Move the patty to a cooler zone on the grill, or turn the pan heat to low before adding the cheese, to prevent the fat from breaking."},
      ...
      {image:A.heroEditorial,kicker:"AGED CHEESE",title:"Matching the meat",body:"Strong cheeses belong on strong burgers. A sharp, funky blue cheese or a mature cheddar pairs beautifully with the earthy notes of a lamb or beef-lamb blend."}
    ]},
    {id:"cm-the-steam-dome",title:"The Steam Dome Technique",minutes:4,slides:[
      ...
      {image:A.heroSteakhouse,kicker:"STEAM DOME",title:"The water splash",body:"Add the cheese, drop a teaspoon of water into the hot pan next to the patty, and immediately cover with a dome. The water vaporizes instantly, enveloping the cheese in hot steam."},
      ...
      {image:A.finished,kicker:"STEAM DOME",title:"The equipment",body:"A dedicated metal burger dome is great, but any heat-safe bowl, a deep pan lid, or even a disposable aluminium pie tin works perfectly. You just need to trap the vapour."},
    ...
    {id:"cm-timing-the-melt",title:"Timing the Melt",minutes:4,slides:[
      {image:A.heroEditorial,kicker:"CHEESE & THE MELT",title:"The final countdown",body:"Cheese should be the absolute last thing that happens in the pan. Add it only when the burger is within 30 seconds of being completely finished."},
      ...
      {image:A.heroSteakhouse,kicker:"TIMING",title:"The residual melt",body:"If you are using American cheese on a hot smash patty, you can often turn the heat completely off when you add the cheese. The residual heat in the meat and pan is enough."},
      ...
      {image:A.finished,kicker:"TIMING",title:"Multiple slices",body:"If you are using two slices of cheese on a single patty, offset them to create an eight-point star. This ensures the cheese drapes evenly over the edges instead of pooling in one spot."}
    ]},
    {id:"cm-cheese-as-glue",title:"Cheese as Structural Glue",minutes:4,slides:[
      ...
      {image:A.heroEditorial,kicker:"STRUCTURAL GLUE",title:"The double patty lock",body:"In a double smash burger, the cheese goes between the patties. It melts and fuses the two thin patties into a single, cohesive structural unit that won't slide apart."},
      ...
      {image:A.heroSteakhouse,kicker:"STRUCTURAL GLUE",title:"The bottom cheese shield",body:"Placing a slice of cheese on the bottom bun under the hot patty creates a waterproof fat barrier. It prevents the meat juices from turning the bottom bun to mush."},
  ...
  "assembly-architecture":[
    {id:"aa-the-bun",title:"Bun Selection and Toasting",minutes:5,slides:[
      ...
      {image:A.yoghurtSauce,kicker:"THE BUN",title:"Potato vs. Brioche",body:"Potato buns are the gold standard — squishy, resilient, and mildly sweet. Brioche is rich and buttery but can be too fragile and cake-like for a heavy, juicy burger."},
      ...
      {image:A.bunPotatoToasted,kicker:"THE BUN",title:"The fat barrier",body:"Always toast with fat. A thin layer of mayonnaise or butter on the bun before toasting browns it beautifully and adds a hydrophobic (water-repelling) layer of fat to protect the crumb."},
    ...
    {id:"aa-sauce-placement",title:"Sauce Placement and Barriers",minutes:4,slides:[
      ...
      {image:A.yoghurtSauce,kicker:"SAUCE",title:"The bottom bun rule",body:"Always sauce the bottom bun. This anchors the patty and ensures the sauce hits your tongue first, delivering immediate acidic contrast to the rich meat."},
      ...
      {image:A.heroTopdown,kicker:"SAUCE",title:"Edge to edge coverage",body:"Spread the sauce evenly from edge to edge. A massive dollop in the centre will squeeze out the sides on the first bite, leaving the rest of the burger dry."},
    ...
    {id:"aa-stacking-order",title:"The Order of Operations",minutes:6,slides:[
      ...
      {image:A.toast,kicker:"STACKING",title:"The bottom heavy rule",body:"The patty is the heaviest item. It belongs low in the stack, resting directly on the bottom bun (or a sauce/pickle layer). Putting thick veg under the patty makes it unstable."},
      ...
      {image:A.sauce,kicker:"STACKING",title:"Lettuce placement",body:"Shredded iceberg lettuce on the bottom bun creates a dry bed for the patty to sit on, catching juices. A whole leaf of butter lettuce on top protects the top bun from steam."},
    ...
    {id:"aa-temperature-contrast",title:"Temperature Contrast",minutes:4,slides:[
      ...
      {image:A.heroTopdown,kicker:"CONTRAST",title:"Keep veg cold",body:"Keep your lettuce, tomatoes, and pickles in the fridge until the exact moment of assembly. Warm, wilted lettuce ruins the structural contrast of the burger."},
      ...
      {image:A.heroEditorial,kicker:"CONTRAST",title:"Melting the cheese",body:"The cheese is the bridge between hot and cold. It must be fully melted on the hot patty before assembly, so it drapes and holds the colder toppings in place."},
    ...
    {id:"aa-the-final-bite",title:"Eating Mechanics",minutes:4,slides:[
      {image:A.bunPotatoToasted,kicker:"ASSEMBLY ARCHITECTURE",title:"The bite test",body:"The ultimate test of your architecture is the first bite. The bun should yield, the meat should shear cleanly, and the toppings should stay exactly where you put them."},
      ...
      {image:A.layers,kicker:"MECHANICS",title:"The hold",body:"Hold the burger with both thumbs supporting the back of the bottom bun, and your fingers spread across the top. This pinches the back closed, preventing ingredients from shooting out."},
      ...
      {image:A.heroClassic,kicker:"MECHANICS",title:"The last bite",body:"If the last bite of the burger has the exact same ratio of bun, meat, cheese, and sauce as the first bite, your assembly was flawless."}
    ]}
  ]
};
