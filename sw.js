...
const IMG_LIMIT = 200;
const SHELL = ["./", "./index.html", "./css/app.css", "./css/polish.css", "./js/app.js", "./js/polish.js", "./js/cook-build.js", "./js/install.js", "./js/install-qr.js", "./js/assets.js", "./js/data.js", "./js/builder-data.js", "./js/recipes-data.js", "./js/sides-data.js", "./js/flavours-data.js", "./js/steak-designer-data.js", "./js/steak-cook.js", "./js/steak-recipes.js", "./js/steak-flavours.js", "./js/steak-lessons-data.js", "./js/steak-sides-data.js", "./js/burger-lessons-data.js", "./js/share-card.js", "./manifest.webmanifest", "./icons/icon.svg", "./icons/logo-mark.svg", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon-maskable-512.png", "./icons/apple-touch-icon.png"];
